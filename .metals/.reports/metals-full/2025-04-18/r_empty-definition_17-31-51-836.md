...
val input2 = StdIn.readLine("Enter 'options' to show you the available recipes or 'R' for a random one.\n")
if(input2=="options" )println("\n1.Carbonara\n 2.Guacomole\n 3.Chai\n 4.Sushi rice\n")
input2.trim.toLowerCase match{
 
  case "carbonara" | "1" => Some("Eggs, pecorino, guanciale, black pepper.\n")
  case "guacomole" | "2"=> Some("Mash avocados with lime, onion, cilantro\n")
